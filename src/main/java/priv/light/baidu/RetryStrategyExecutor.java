...
@Slf4j
public class RetryStrategyExecutor implements ExecChainHandler {

    private final HttpUtil httpUtil;
    private final HttpRequestRetryStrategy retryStrategy;

    public RetryStrategyExecutor(@NonNull HttpUtil httpUtil, @NonNull RetryStrategy retryStrategy) {
